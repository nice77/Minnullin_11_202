...
public class Main {
    public static void main(String[] args) {
        ...
        db.getByName("user").getTree().print();
        BinTree<AbstractModel> tree = db.getByName("user").getTree();
        System.out.println(tree.search(new User("Danil")));
        System.out.println("----------");
        tree.remove(new User("Niyaz"));
        tree.print();
//        for (AbstractModel group : db.getByName("group").getTable()) {
